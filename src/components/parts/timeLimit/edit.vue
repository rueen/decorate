...
<template>
  <div>
    ...
    <table class="table w100 pl10">
      ...
      <tr>
        ...
        <td colspan="2" class="valign-m">
          <input type="text" class="form-control" v-model="data.activityId">
        </td>
        <td class="valign-m">
    ...
    <div class="showBtns">
      ...
      <div class="btns">
        <input type="checkbox"  v-model="data.isShowBuyNum">
        <label>显示已售</label>
      </div>
      <div class="btns">
        <input type="checkbox"  v-model="data.isShowEnableStore">
        <label>显示当前库存</label>
      </div>
      <div class="btns">
        <input type="checkbox"  v-model="data.isShowTime">
        <label>显示限时活动时间</label>
      </div>
      <div class="btns">
        <input type="checkbox"  v-model="data.isShowLabel">
        <label>显示活动标签</label>
      </div>
