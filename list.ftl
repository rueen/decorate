...
<div class="row">
	<div class="col-md-12">
		<div class="hd-ui-wrap">
			<div style= "background:#E7E7EB;margin-bottom : 20px;padding : 20px 30px 20px 29px;">
                 <label style= "font-size:21px;padding:0 120px 0 0;line-height: 33px;">商城首页</label>   
                 ...
                 <a href="javascript:;" data-toggle="popover"  class="promotion">
									二维码</a>
						<#if isUserDefaultDecoration?? && isUserDefaultDecoration == 1><br><span>（当前使用海带默认模板，同步海带微商城内容，如需自定义模板，请新建页面并设为首页）</span></#if>	
			                    </div>
